...
| 异常 | 错误码 | 处理逻辑 |
|------|--------|----------|
| 分页参数非法 | AGENT_PARAM_ERROR | 返回400，提示参数错误 |
...
| 异常 | 错误码 | 处理逻辑 |
|------|--------|----------|
| 编码已存在 | AGENT_BUSINESS_ERROR | 返回400，提示编码已存在 |
| 参数非法 | AGENT_PARAM_ERROR | 返回400，提示参数错误 |
...
| 异常 | 错误码 | 处理逻辑 |
|------|--------|----------|
| 岗位类型不存在 | AGENT_BUSINESS_ERROR | 返回404，提示岗位类型不存在 |
| 参数非法 | AGENT_PARAM_ERROR | 返回400，提示参数错误 |
...
| 异常 | 错误码 | 处理逻辑 |
|------|--------|----------|
| 岗位类型不存在 | AGENT_BUSINESS_ERROR | 返回404 |
| 状态值非法 | AGENT_PARAM_ERROR | 返回400 |
...
|------|--------|----------|
| 岗位类型不存在 | AGENT_BUSINESS_ERROR | 返回404 |
| 存在绑定员工 | AGENT_BUSINESS_ERROR | 返回400，提示存在绑定员工无法删除 |
...
| 错误码 | 错误信息 | 场景 |
|--------|----------|------|
| 10092001 | 岗位类型业务错误 | 通用业务错误 |
| 10092002 | 岗位编码已存在 | 新增/更新时编码重复 |
| 10092003 | 岗位类型不存在 | 查询/更新不存在的岗位 |
| 10092004 | 存在绑定员工无法删除 | 删除时有员工绑定 |
| 10091001 | 岗位类型参数错误 | 参数非法 |
