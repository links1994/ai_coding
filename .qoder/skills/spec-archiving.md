---
name: spec-archiving
description: 技术规范归档 Skill，将技术规范、编码标准、架构规范等归档到 repowiki/zh/docs/specs，便于代码迭代时查询
language: zh-CN
output_language: 中文
...
将技术规范、编码标准、架构规范、接口规范等归档到 `repowiki/zh/docs/specs/` 目录，建立可查询的技术规范知识库，支持代码迭代和规范一致性检查。
...
- 规范文档：`repowiki/zh/docs/specs/{spec-name}.md`
- 更新索引：`repowiki/zh/docs/specs/index.md`
- 模板文件（如需要）：`repowiki/zh/docs/specs/_TEMPLATE/{template-name}.md`
...
更新 `repowiki/zh/docs/specs/index.md`：
...
规范模板存放在 `repowiki/zh/docs/specs/_TEMPLATE/` 目录：
...
Agent:
  → 分析规范信息
  → 使用模板创建文档
  → 文件: repowiki/zh/docs/specs/feign-client-naming-spec.md
  → 更新索引: repowiki/zh/docs/specs/index.md
...
```
状态：已归档
文档路径：repowiki/zh/docs/specs/{spec-name}.md
索引更新：repowiki/zh/docs/specs/index.md
